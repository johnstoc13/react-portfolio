                ...
                <div className="col-md-6 my-md-2">
                    <ul className="navbar-nav flex-row justify-content-md-end justify-content-center">
                        <li className="nav-item">
                            <a className="nav-link text-white px-2 mx-2" href="/react-portfolio/">ABOUT</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link text-white px-3 py-0 mt-2 border-left border-right"
                                href="/react-portfolio/portfolio">PORTFOLIO</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link text-white px-2 mx-2" href="/react-portfolio/contact">CONTACT</a>
                        </li>
                    </ul>
                </div>
            </div>
